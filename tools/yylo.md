...
evidenceSources:
  ...
  - title: "YYLO CLI npm registry metadata"
    ...
    claim: "The npm registry metadata for @yylo/cli shows the published package (latest 0.2.10, MIT) with bin commands yylo, yy, and ypl, confirming npm distribution of the yylo and yy commands."
